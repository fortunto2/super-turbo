...
var core = require('@turbo-super/core');
...
var SuperDuperAIClient = class {
  constructor(config) {
    this.client = axios__default.default.create({
      baseURL: core.API_ENDPOINTS.SUPERDUPERAI_BASE_URL,
      timeout: 3e4,
      ...config
    });
...
var StripeClient = class {
  constructor(config) {
    this.client = axios__default.default.create({
      baseURL: core.API_ENDPOINTS.STRIPE_BASE_URL,
      timeout: 3e4,
      ...config
    });
    this.client.interceptors.request.use((config2) => {
...
var UploadClient = class {
  constructor(config) {
    this.client = axios__default.default.create({
      baseURL: core.API_ENDPOINTS.UPLOAD_BASE_URL,
      timeout: 6e4,
...
var WebSocketClient = class {
  constructor(url = core.API_ENDPOINTS.WEBSOCKET_BASE_URL, options = {}) {
    this.url = url;
...
exports.FREE_BALANCE_BY_USER_TYPE = FREE_BALANCE_BY_USER_TYPE;
exports.GenerationType = GenerationType;
exports.ImageGenerationStrategyFactory = ImageGenerationStrategyFactory;
exports.ImageToImageStrategy = ImageToImageStrategy;
exports.ImageToVideoStrategy = ImageToVideoStrategy;
exports.ListOrder = ListOrder;
exports.PRICING_EXAMPLES = PRICING_EXAMPLES;
exports.STRIPE_ENDPOINTS = STRIPE_ENDPOINTS;
exports.StripeClient = StripeClient;
exports.SuperDuperAIClient = SuperDuperAIClient;
exports.TOOLS_PRICING = TOOLS_PRICING;
...
exports.VideoGenerationStrategyFactory = VideoGenerationStrategyFactory;
exports.WebSocketClient = WebSocketClient;
exports.calculateOperationCost = calculateOperationCost;
exports.checkOperationBalance = checkOperationBalance;
exports.clearModelCache = clearModelCache;
exports.createBalanceTransaction = createBalanceTransaction;
exports.generateImageWithStrategy = generateImageWithStrategy;
exports.generateVideoWithStrategy = generateVideoWithStrategy;
exports.getCacheStats = getCacheStats;
exports.getCachedModels = getCachedModels;
exports.getClientSuperduperAIConfig = getClientSuperduperAIConfig;
exports.getOperationCost = getOperationCost;
exports.getPricingInfo = getPricingInfo;
exports.getSuperduperAIConfig = getSuperduperAIConfig;
exports.getToolOperations = getToolOperations;
exports.getToolPricingDisplay = getToolPricingDisplay;
exports.stripeClient = stripeClient;
exports.superDuperAIClient = superDuperAIClient;
exports.uploadClient = uploadClient;
