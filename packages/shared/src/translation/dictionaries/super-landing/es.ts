...
export const es: NestedDictionary = {
  ...
  "hero": {
    ...
    "description": "Plataforma AI revolucionaria para crear videos profesionales sin habilidades, equipamiento o presupuesto. 10x más rápido y barato.",
    "cta": "Comenzar a Crear Gratis"
  },
  "features": {
    "section_title": "Qué Hace que SuperDuperAI sea Súper",
    "section_description": "Características y tecnologías avanzadas para crear videos impresionantes",
    "list": [
      {
        "icon": "users",
        "title": "Personajes Personalizados con Memoria AI",
        "description": "Tu base de datos de actores AI usando tecnología LoRA. Crea y guarda personajes únicos para tus videos."
      },
      {
        "icon": "image",
        "title": "Controles de Cámara Cinematográficos",
        "description": "Panes, zooms, bullet-time — sin cámaras físicas. Añade movimientos profesionales de cámara con un clic."
      },
      {
        "icon": "settings",
        "title": "Flujo de Trabajo AI Multi-Agente",
        "description": "Un modelo donde cada agente hace su trabajo. AI especializado para guión, filmación, edición y sonido."
      },
      {
        "icon": "speed",
        "title": "Rápido y Eficiente",
        "description": "Idea → video en minutos, no horas o días. Acelera tu flujo de trabajo y crea más contenido."
      },
      {
        "icon": "chart",
        "title": "Ahorro de Costos",
        "description": "Cinematografía con presupuesto. Obtén video profesional sin gastar en equipo y equipamiento."
      },
      {
        "icon": "edit",
        "title": "Edición e Integración Fácil",
        "description": "Storyboard, arrastrar y soltar, exportar a TikTok/YouTube. Interfaz intuitiva para finalizar rápidamente tu video."
      }
    ]
  },
  "howItWorks": {
    "section_title": "Cómo Funciona",
    "section_description": "Dirige tu video en 3 pasos fáciles – los agentes AI se encargan del resto.",
    "steps": [
      {
      ...
      },
      {
        ...
        "description": "Ajusta el estilo, exporta tu video y compártelo con el mundo"
      }
    ]
  },
  "useCases": {
  ...
  "cta": {
    ...
    "description": "Únete a SuperDuperAI y comienza a crear videos increíbles ahora mismo.",
  ...
  "pricing": {
    ...
    "banner_desc": "Los nuevos usuarios obtienen 100 créditos completamente gratis - suficientes para crear múltiples proyectos y explorar casi todas nuestras características. Prueba el poder de la creatividad AI sin compromisos.",
  ...
  "video_generator": {
    ...
    "placeholder": "Por ejemplo: Hermoso atardecer sobre el océano con olas, filmado desde vista de pájaro, calidad cinematográfica, movimientos suaves de cámara...",
    "duration": "Duración",
    ...
    "upload_image_required": "Por favor sube una imagen para generación de imagen a video",
    "insufficient_balance": "Créditos insuficientes. Requerido: {required} créditos. Por favor recarga tu saldo.",
    "insufficient_balance_fallback": "Créditos insuficientes para generación de video. Por favor recarga tu saldo.",
    ...
    "create_amazing_videos": "Crea increíbles videos generados por AI por solo $1.00",
    ...
    "payment_successful": "¡Pago exitoso! La generación de video comenzará pronto.",
    "advanced_ai_model": "Modelo avanzado de generación de video AI",
    "supports_both_modes": "✨ Este modelo soporta tanto generación text-to-video como image-to-video",
    "image_to_video": "Imagen a Video",
    "upload_source_image": "Subir Imagen Fuente (Opcional)",
    "upload_image_description": "Sube una imagen para generación de imagen a video, o déjala vacía para text-to-video",
  ...
  "image_generator": {
    ...
    "insufficient_balance": "Créditos insuficientes. Requerido: {required} créditos. Por favor recarga tu saldo.",
    "insufficient_balance_fallback": "Créditos insuficientes para generación de imágenes. Por favor recarga tu saldo.",
    "generate_for": "Generar por {price}",
    "payment_error": "Pago fallido. Por favor intenta de nuevo.",
  ...
  "model_descriptions": {
    ...
    "google_imagen_4": "Google Imagen 4 - modelo AI avanzado para crear imágenes de alta calidad",
    "gpt_image_1": "GPT-Image-1 - modelo de generación de imágenes de OpenAI",
    "flux_kontext": "Flux Kontext - modelo avanzado para generación creativa de imágenes"
  },
  "credit_balance": {
  ...
  "stripe_payment": {
    ...
    "top_up_balance_desc": "Recarga tu saldo con {amount} créditos para usar herramientas AI",
    "generate_video_desc": "¡Tu prompt está listo! Elige un plan para generar videos AI profesionales con Google VEO3.",
    "top_up_credits": "Recargar {amount} créditos",
    "generate_video": "Generar Video",
    "get_credits_desc": "Obtén {amount} créditos para generar imágenes, videos y guiones",
    ...
    "instant_access": "✓ Acceso instantáneo • ✓ Sin suscripción • ✓ Pago seguro Stripe",
