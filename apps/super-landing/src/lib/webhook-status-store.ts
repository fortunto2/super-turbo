...
export async function storeWebhookStatusWithFallback(
  sessionId: string,
...
export async function getWebhookStatusWithFallback(
  sessionId: string
...
export async function updateWebhookStatusWithFallback(
  sessionId: string,
...
export const webhookStatusStore = {
  set: (key: string, value: WebhookStatusData) =>
    storeWebhookStatusWithFallback(key, value),
