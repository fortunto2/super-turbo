              ...
              <CardContent className="space-y-4">
                ...
                {supportsImageToVideoMode && (
                  <ImageUpload
                    ...
                    className="mt-4"
                    title="Upload Source Image (Optional)"
                    description="Upload an image for image-to-video generation, or leave empty for text-to-video"
                    required={false}
                  />
                )}
                ...
                <div className="space-y-2">
                  ...
                  {supportsImageToVideoMode && (
                    <p className="text-sm text-blue-300">
                      ✨ This model supports both text-to-video and
