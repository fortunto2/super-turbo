    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.fileId && data.status !== "error") {
          ...
          if (!status.fileId) {
            // Only redirect once when fileId appears
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Thank you for your purchase. We&apos;re processing your video
          generation request.
        </p>
      </div>
          ...
          {countdown < 45 && (
            <div className="text-center mt-4">
              <p className="text-sm text-muted-foreground mb-2">
                Having trouble? You can always find your file using this session
                ID:
              </p>
