...
export function SimpleVeo3Generator() {
  ...
  // Get tool info from URL path using useEffect to avoid hydration mismatch
  useEffect(() => {
    ...
    if (toolMatch) {
      ...
      const toolTitle =
        document.title.split(" | ")[0] || toolSlug.replace(/-/g, " ");
      setToolInfo({ toolSlug, toolTitle });
    }
  }, []);
  ...
  const randomizePrompt = () => {
    const randomData: PromptData = {
      ...
      language:
        PRESET_OPTIONS.languages[
          Math.floor(Math.random() * PRESET_OPTIONS.languages.length)
        ],
      style:
        PRESET_OPTIONS.styles[
          Math.floor(Math.random() * PRESET_OPTIONS.styles.length)
        ],
      camera:
        PRESET_OPTIONS.cameras[
          Math.floor(Math.random() * PRESET_OPTIONS.cameras.length)
        ],
      lighting:
        PRESET_OPTIONS.lighting[
          Math.floor(Math.random() * PRESET_OPTIONS.lighting.length)
        ],
      mood: PRESET_OPTIONS.moods[
        Math.floor(Math.random() * PRESET_OPTIONS.moods.length)
      ],
    };
                ...
                <div className="space-y-4">
                  ...
                  {promptData.characters.length === 0 && (
                    <div className="text-sm text-muted-foreground p-4 border border-dashed rounded-lg text-center">
                      No characters added yet. Click &ldquo;Add Character&rdquo;
                      to start.
                    </div>
                  )}
                        ...
                        <div className="relative">
                          ...
                          {character.speech && (
                            <div className="mt-1 text-xs text-blue-600 flex items-center gap-1">
                              <span>🔊</span>
                              <span>
                                This dialogue will be highlighted in the
                                enhanced prompt
                              </span>
                            </div>
                          )}
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {PRESET_OPTIONS.styles.map((style) => (
                        <Badge
                          key={style}
                          variant={
                            promptData.style === style ? "default" : "outline"
                          }
                          className="cursor-pointer text-xs"
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {PRESET_OPTIONS.cameras.map((camera) => (
                        <Badge
                          key={camera}
                          variant={
                            promptData.camera === camera ? "default" : "outline"
                          }
                          className="cursor-pointer text-xs"
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {PRESET_OPTIONS.moods.map((mood) => (
                        <Badge
                          key={mood}
                          variant={
                            promptData.mood === mood ? "default" : "outline"
                          }
                          className="cursor-pointer text-xs"
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={
                      (!generatedPrompt && !enhancedPrompt) || isEnhancing
                    }
                    size="lg"
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                    <Button
                      variant={
                        selectedFocusTypes.includes("character")
                          ? "default"
                          : "outline"
                      }
                      size="sm"
                    ...
                    <Button
                      variant={
                        selectedFocusTypes.includes("action")
                          ? "default"
                          : "outline"
                      }
                      size="sm"
                    ...
                    <Button
                      variant={
                        selectedFocusTypes.includes("cinematic")
                          ? "default"
                          : "outline"
                      }
                      size="sm"
                        ...
                        <div className="flex items-center gap-3">
                          <span>
                            ...
                            <span className="font-medium text-foreground">
                              {enhancementInfo.modelName ||
                                enhancementInfo.model}
                            </span>
                          </span>
                          <span>
                            Length:{" "}
