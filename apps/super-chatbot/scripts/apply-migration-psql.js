...
async function applyMigration() {
  ...
  try {
    ...
    console.log(
      '    ALTER TABLE \\"UserProject\\" ADD COLUMN IF NOT EXISTS \\"status\\" varchar(20) NOT NULL DEFAULT \\"pending\\",',
    );
    console.log(
    ...
    console.log(
      '✅ After applying the migration, the API will work with full error handling!',
    );
  } catch (error) {
