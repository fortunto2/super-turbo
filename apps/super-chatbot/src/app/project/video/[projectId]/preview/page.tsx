            ...
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-white/20 dark:border-slate-700/50">
              ...
              <div className="space-y-3">
                {scenes.slice(0, 3).map((scene, index) => (
                  ...
                  >
                    <div className="size-6 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center text-xs font-medium text-purple-700 dark:text-purple-300">
                      {index + 1}
                    </div>
                    <span className="text-sm text-gray-600 dark:text-gray-400 truncate">
                      {scene.visual_description?.substring(0, 30)}...
                    </span>
                  </div>
                ))}
                {scenes.length > 3 && (
